...
async def uploadfiles(files: List[UploadFile] = File(...)):
    ...
    Output: list of lenght = 3 containing the description of each step. eg: ['fold the paper in two then fold the corner to the center line generated by the first fold ...','fold the tip of the airplane in the direction of the center ...','fold the sides to generate the ariplane wings ...']
    """
